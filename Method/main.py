...
def get_args():
    ...
    parser.add_argument('-num_epochs', type=int, default=4500, help='epochs')
    parser.add_argument('-batch', type=int, default=1, help='batch size')
    parser.add_argument('-lr', type=float, default=0.001, help='learning rate')
    parser.add_argument('-n_gcn', type=float, default=2, help='number of gcns')
    parser.add_argument('-n_train_sampl', type=int, default=1, help='number of training samples')
    ...
    parser.add_argument('-l_dim', type=int, default=512, help='layer dim')
    ...
    parser.add_argument('-act_i', type=str, default='ReLU', help='network act input')
    parser.add_argument('-act_o', type=str, default='ReLU', help='network act hidden')
    parser.add_argument('-act_n', type=str, default='ReLU', help='network act output')
